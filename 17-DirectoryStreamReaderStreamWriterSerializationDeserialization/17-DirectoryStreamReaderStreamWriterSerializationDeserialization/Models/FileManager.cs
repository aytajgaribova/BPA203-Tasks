...
public class FileManager
{
        ...
        public void CreateFolder()
    {
        ...
        {
            Console.WriteLine("Qovluq artiq movcuddur.");
        }
    }
    ...
    public void DeleteFolder()
    {
        ...
        {
            Console.WriteLine("Silinecekk qovluq tapilmadi.");
        }
    }
    ...
    public void WriteStudentToFile(Student student)
    {
        ...
        Console.WriteLine($"Telebe fayla yazildı: {student.Name}");
    }
    ...
    public void WriteAllStudentsToFile(List<Student> students)
    {
        ...
        Console.WriteLine($"umumi {students.Count} telebe fayla yazıldı.");
    }
    ...
    public void SerializeToJson(List<Student> students)
    {
        ...
        Console.WriteLine($"Telebeler JSON formatinda yadda saxlanıldi: {JsonFilePath}");
    }
    ...
    public List<Student> DeserializeFromJson()
    {
        ...
        {
            Console.WriteLine("JSON fayli tapılmadi!");
            return students;
        }
        ...
        Console.WriteLine($"JSON-dan {students.Count} telebe yuklendi.");
        return students;
    }
}
